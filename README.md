...
![1768290834367](image/README/1768290834367.png)
![1768291111200](image/README/1768291111200.png)
...
* 在账号列表中，找到状态为“有效”的账号。
* 点击卡片右侧的 **"切换账号"** 按钮。
* 应用会自动将该账号的凭证复制到 Codex CLI 配置文件 (`~/.codex/auth.json`)。
* 账号文件存储在 `~/.myswitch/accounts/` 目录下，可在设置中自定义路径。
